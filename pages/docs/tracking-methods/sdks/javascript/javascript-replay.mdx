...
To enable Session Replay and set your sampling rate, set the `record_sessions_percent` when initializing the SDK. This is the only change needed in your existing JavaScript SDK implementation to enable Session Replay.
