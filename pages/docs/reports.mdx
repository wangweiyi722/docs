...
Depending on the behavior, certain measurements may be not be possible. For example, you cannot measure the conversion rate of only a single event.  The measurement is chosen at the bottom left area of the metric.
